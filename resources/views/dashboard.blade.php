    ...
    @can('administrador')
        <div class="flex flex-col justify-center items-center text-center pt-4">
            <div
                ...
                <div
                    class="relative flex flex-grow  flex-col items-center rounded-[10px] border-[1px] border-gray-900  bg-clip-border shadow-md shadow-[#F3F3F3] dark:border-[#ffffff33] dark:!bg-navy-800 dark:text-white dark:shadow-none">
                    ...
                    @if ($notas->count() > 0)
                        @foreach ($notas->groupBy('curso_id') as $cursoId => $notasPorCurso)
                            ...
                            <tbody>
                                ...
                                @if ($contadorNotas > 0)
                                    <tr
                                        class="text-white box-content bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <th scope="row"
                                            class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            Promedio</th>
