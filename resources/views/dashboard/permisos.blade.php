                ...
                <div
                    ...
                    <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                        ...
                        <div class="flex items-center justify-between space-x-4">
                            <h1 class="text-xl font-medium text-gray-800 ">Nuevo Permiso</h1>
                        ...
                        <form class="mt-5" method="POST" action="{{ route('permisos.store') }}">
                            @csrf
                            <div>
                                <label for="user name"
                                    class="block text-sm text-gray-700 capitalize dark:text-gray-900">Nombre del
                                    Permiso</label>
                                <input placeholder="Nuevo Permiso" type="text" name="name" id="name"
